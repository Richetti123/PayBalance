...
export function smsg(conn, m, doNotReply = false) {
    ...
    // `isOwner` (se define en handler.js, aquí solo lo dejo como referencia si se necesitara)
    // m.isOwner = m.sender === 'TU_NUMERO_DE_ADMIN@s.whatsapp.net'; // Se define en handler.js
