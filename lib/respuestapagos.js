...
export async function manejarRespuestaPago(m, conn) {
    ...
    // Si la respuesta es de la lista de servicios, simplemente devolvemos false para que el handler principal lo procese
    if (m.message?.listResponseMessage?.singleSelectReply) {
        return false;
    }
